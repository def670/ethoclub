(function() {
    ...
    $$es51$$defineProperty($$core1$$MessageFormat, '__parse', {value: $ember$intl$intl$messageformat$parser$$default.parse});
    ...
    var $ember$intl$intl$messageformat$$default = $$core1$$default;
    ...
    $$es5$$defineProperty($$core$$RelativeFormat, '__addLocaleData', {value: function (data) {
        ...
        $ember$intl$intl$messageformat$$default.__addLocaleData(data);
    }});
    ...
    $$core$$RelativeFormat.prototype._compileMessage = function (units) {
        ...
        return new $ember$intl$intl$messageformat$$default(message, locales);
    };
